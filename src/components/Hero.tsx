...
const Hero = ({ onOpenModal }: HeroProps) => {
  return (
    <section className="pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 bg-gradient-to-br from-secondary to-background">
      <div className="container mx-auto max-w-5xl">
        <div className="text-center animate-fade-in-up">
          ...
          <Button 
            onClick={onOpenModal}
            size="lg"
            className="bg-primary hover:bg-primary-hover text-primary-foreground font-bold text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 h-auto shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 mb-3 sm:mb-4 w-full sm:w-auto min-h-[48px]"
          >
