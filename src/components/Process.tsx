      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="space-y-4 sm:space-y-6">
          {steps.map((step, index) => (
            <div 
              key={index}
              className="relative bg-card border border-border rounded-xl p-5 sm:p-6 md:p-8 hover:border-primary transition-all duration-300 hover:shadow-lg animate-fade-in"
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-4 sm:gap-6">
                <div className="flex-shrink-0">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-primary/10 rounded-full flex items-center justify-center">
                    <span className="text-xl sm:text-2xl font-bold text-primary">{index + 1}</span>
                  </div>
                </div>
